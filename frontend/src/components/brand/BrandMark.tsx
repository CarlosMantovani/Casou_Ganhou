  ...
  return (
    <div className="text-center">
      <svg aria-hidden="true" className="mx-auto mb-4 h-16 w-28" viewBox="0 0 130 82" fill="none">
        <circle cx="45" cy="41" r="30" stroke="#C9A227" strokeWidth="5.5" fill="none" opacity="0.88" />
        <circle cx="85" cy="41" r="30" stroke="#C9A227" strokeWidth="5.5" fill="none" opacity="0.88" />
        <path d="M65 15 L69 23 L65 31 L61 23 Z" fill="#C9A227" opacity="0.72" />
      </svg>
